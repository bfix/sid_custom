...
///////////////////////////////////////////////////////////////////////
// Local static attributes
/*
 * list of cover POST replacements
 */
 ...
 */
func GetCoverAddress() string {
	return "imgon.net:80"
}

//=====================================================================
func GetCoverHtmls() map[string]string {
 ...
 *<nl>
 */
func GetUploadForm (delim, name, mime, cmt string, data []byte) (string, int) {
	...
	posts[delim] = []byte(post)
	return "/upload/" + delim, len(posts[delim])+32
} 
 ...
 */
func GetPostContent (id string) []byte {
